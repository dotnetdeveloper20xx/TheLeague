        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientFilter = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredPaymentProvider = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiredMemberships = table.Column<int>(type: "int", nullable: false),
                    TotalRevenueThisMonth = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalRevenueThisYear = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    OutstandingPayments = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    SessionsThisMonth = table.Column<int>(type: "int", nullable: false),
                    TotalBookingsThisMonth = table.Column<int>(type: "int", nullable: false),
                    AverageAttendanceRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    EventsThisMonth = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubAnalyticsSnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubAnalyticsSnapshots_Clubs_ClubId",
                        column: x => x.ClubId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequireEmergencyContact = table.Column<bool>(type: "bit", nullable: false),
                    RequireMedicalInfo = table.Column<bool>(type: "bit", nullable: false),
                    AllowFamilyAccounts = table.Column<bool>(type: "bit", nullable: false),
                    AllowOnlinePayments = table.Column<bool>(type: "bit", nullable: false),
                    AllowManualPayments = table.Column<bool>(type: "bit", nullable: false),
                    AutoSendPaymentReminders = table.Column<bool>(type: "bit", nullable: false),
                    PaymentReminderDaysBefore = table.Column<int>(type: "int", nullable: false),
                    PaymentReminderFrequency = table.Column<int>(type: "int", nullable: false),
                    AllowMemberBookings = table.Column<bool>(type: "bit", nullable: false),
                    MaxAdvanceBookingDays = table.Column<int>(type: "int", nullable: false),
                    CancellationNoticePeriodHours = table.Column<int>(type: "int", nullable: false),
                    EnableWaitlist = table.Column<bool>(type: "bit", nullable: false),
                    SendWelcomeEmail = table.Column<bool>(type: "bit", nullable: false),
                    SendBookingConfirmations = table.Column<bool>(type: "bit", nullable: false),
                    SendPaymentReceipts = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_Members_PrimaryMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    MinAge = table.Column<int>(type: "int", nullable: true),
                    MaxAge = table.Column<int>(type: "int", nullable: true),
                    MaxFamilyMembers = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AllowOnlineSignup = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    IncludesBooking = table.Column<bool>(type: "bit", nullable: false),
                    IncludesEvents = table.Column<bool>(type: "bit", nullable: false),
                    MaxSessionsPerWeek = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyMembers_Members_PrimaryMemberId",
                        column: x => x.PrimaryMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberTicketPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    TicketSalesEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringSchedules_Venues_VenueId",
                        column: x => x.VenueId,
                        principalTable: "Venues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventTicketId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    ManualPaymentReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringBookings_FamilyMembers_FamilyMemberId",
                        column: x => x.FamilyMemberId,
                        principalTable: "FamilyMembers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RecurringBookings_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringBookings_RecurringSchedules_RecurringScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessions_RecurringSchedules_RecurringScheduleId",
                        column: x => x.RecurringScheduleId,
                        principalTable: "RecurringSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionBookings_FamilyMembers_FamilyMemberId",
                        column: x => x.FamilyMemberId,
                        principalTable: "FamilyMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubAnalyticsSnapshots_ClubId_SnapshotDate",
                table: "ClubAnalyticsSnapshots",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyMembers_PrimaryMemberId",
                table: "FamilyMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_PrimaryMemberId",
                table: "Members",
                column: "PrimaryMemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringBookings_FamilyMemberId",
                table: "RecurringBookings",
                column: "FamilyMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringBookings_MemberId",
                table: "RecurringBookings",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringBookings_RecurringScheduleId",
                table: "RecurringBookings",
                column: "RecurringScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringSchedules_VenueId",
                table: "RecurringSchedules",
                column: "VenueId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionBookings_FamilyMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionBookings_SessionId_MemberId_FamilyMemberId",
                table: "SessionBookings",
                columns: new[] { "SessionId", "MemberId", "FamilyMemberId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_RecurringScheduleId",
                table: "Sessions",
                column: "RecurringScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Waitlists_SessionId_Position",
                table: "Waitlists",
